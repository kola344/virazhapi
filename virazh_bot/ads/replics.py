...
replic_news_menu = 'Меню рассылок. Создайте сообщение, которое будет разослано всем зарегистрированным клиентам в боте.\n✨ ChatGPT - поможет сгенерировать рассылку'
replic_news_create = 'Пришлите сообщение для рассылки'
replic_news_got_message = 'Сообщение получено, отправить?'
replic_session_error = '⚠️ Сессия истекла'
replic_news_waiting = '🕙 Отправляю... Это может занять несколько минут'

def replic_news_sended(count, count_sended):
    text = f'✔️ Рассылка отправлена. Отправлено: {count_sended}/{count} '
    return text
