...
api_url = 'https://api.kafevirazh.ru'
...
logs_chat = -4207648967
db_logs_chat = -4690552228
...
order_statuses = {
    ...
    "3": "📦 Готов к отправке",
    "4": "🚚 В пути",
    "5": "📬 Курьер подъехал, выходите!",
    "6": "🏢 Можно забрать самовывоз",
...
🎁 А чтобы было ещё приятнее — вводите промокод при оформлении заказа и получите приятный бонус!
